...
class _StudentFormViewState extends State<_StudentFormView> {
  ...
  String? _validate(String? value) {
    ...
    if (value.trim().length < 1) return 'Debe tener más de 1 caracteres';
    return null;
  }
  ...
  String? _validateId(String? value) {
    if (value == null) return 'No puede ser vacío';
    if (value.trim().isEmpty) return 'No puede ser vacío';
    if (value.trim().length != 6) return 'Debe tener 6 caracteres';
    return null;
  }
    ...
    return Form(
        ...
        child: Column(children: [
          ...
          MultiSelectDropDown(
            ...
            dropdownHeight: 200,
            optionTextStyle:
              TextStyle(fontSize: 15, color: colors.secondaryContainer),              selectedOptionIcon: const Icon(Icons.check_circle),
            borderRadius: 30,
            borderWidth: 1,
            focusedBorderWidth: 2,
            borderColor: colors.secondaryContainer,
            hint: 'Seleccione los cursos',
            hintColor: colors.secondaryContainer,
